...
<div class="container">
    <div class="row justify-content-center">
       <img src="images/homephoto.jpg" style="max-width:120%;" alt="">
      
        <div class="col-10">
        <div class="row">
            <h1 class="text-center text-light" id="textheader">Exploring Indonesia</h1>
        </div>
    ...
    <div class="row">
        <h1 style=" font-weight: bold;">OUR FAVORITES</h1>
    </div>
    ...
    <div class="col-12 mt-4">
        ...
        <div class="d-flex flex-row bd-highlight mb-3">
            ...
            <div class="card mr-4"><a href="/detail/{{$a->id}}">
                @if($a->id%2!=0)
                <img src="/images/{{$a->image}}"  style="height:200px" id ="productimg"class="card-img-top" alt="...">
