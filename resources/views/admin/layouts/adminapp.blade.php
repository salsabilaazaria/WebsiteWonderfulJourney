...
<body >
    <div id="app">
        <nav class="navbar" id="item">
            <div class="container navbar-light justify-content-center mt-2 " id="item">
        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" id="item">
            <div class="container ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link text-white" href="/userdata">User Data</a>
                        </li>
                    @endguest  
